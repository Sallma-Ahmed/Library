export function loadAnimations() {
  let startPage = bodymovin.loadAnimation({
    ...
    path: "../../../lib-native/madinet_elma3refa-parag/assets/json/startPage.json", // required
  ...
  let door0 = bodymovin.loadAnimation({
    ...
    path: "../../../lib-native/madinet_elma3refa-parag/assets/json/doorLeft.json", // required
    renderer: "svg", // required
    loop: false, // optional
  ...
  let star0 = bodymovin.loadAnimation({
    ...
    path: "../../../lib-native/madinet_elma3refa-parag/assets/json/starLeft.json", // required
    renderer: "svg", // required
    loop: false, // optional
    autoplay: true, // optional
    // name: "Feed Right", // optional
  ...
  let door1 = bodymovin.loadAnimation({
    ...
    path: "../../../lib-native/madinet_elma3refa-parag/assets/json/doorCenter.json", // required
    renderer: "svg", // required
    loop: false, // optional
    autoplay: false, // optional
    // name: "Feed Right", // optional
  ...
  let star1 = bodymovin.loadAnimation({
    ...
    path: "../../../lib-native/madinet_elma3refa-parag/assets/json/starCenter.json", // required
    renderer: "svg", // required
    loop: false, // optional
    autoplay: true, // optional
    // name: "Feed Right", // optional
  ...
  let door2 = bodymovin.loadAnimation({
    ...
    path: "../../../lib-native/madinet_elma3refa-parag/assets/json/doorRight.json", // required
    renderer: "svg", // required
    loop: false, // optional
    autoplay: false, // optional
    // name: "Feed Right", // optional
  ...
  let star2 = bodymovin.loadAnimation({
    ...
    path: "../../../lib-native/madinet_elma3refa-parag/assets/json/starRight.json", // required
    renderer: "svg", // required
    loop: false, // optional
    autoplay: true, // optional
    // name: "Feed Right", // optional
  ...
  let soltanDoor = bodymovin.loadAnimation({
    ...
    path: "../../../lib-native/madinet_elma3refa-parag/assets/json/soltanDoor.json", // required
    renderer: "svg", // required
    loop: true, // optional
    autoplay: true, // optional
    // name: "Feed Right", // optional
  ...
  let characterInside = bodymovin.loadAnimation({
    ...
    path: "../../../lib-native/madinet_elma3refa-parag/assets/json/characterInside.json", // required
    renderer: "svg", // required
    loop: true, // optional
    autoplay: true, // optional
    // name: "Feed Right", // optional
  ...
  let doorInHome = bodymovin.loadAnimation({
    ...
    path: "../../../lib-native/madinet_elma3refa-parag/assets/json/doorInHome.json", // required
    renderer: "svg", // required
    loop: false, // optional
    autoplay: true, // optional
    // name: "Feed Right", // optional
