let Path = ''
innerHeight > innerWidth ? Path = '../../../lib-native/dictation_6r/json/portrait/' : Path = '../../../lib-native/dictation_6r/json/landscape/';
...
let finshed = bodymovin.loadAnimation({
    ...
    path: '../../../lib-native/dictation_6r/json/portrait/feedend.json', // required
    renderer: 'svg', // required
    loop: false, // optional
    autoplay: false, // optional
    name: "Feed Right", // optional
