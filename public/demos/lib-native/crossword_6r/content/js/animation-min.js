...
let animation = bodymovin.loadAnimation({
        ...
        path: "../../../lib-native/crossword_6r/content/json/keywords.json",
        renderer: "svg",
        loop: !1,
        autoplay: !1,
        name: "key Words"
    ...
    feedBack = bodymovin.loadAnimation({
        ...
        path: "../../../lib-native/crossword_6r/content/json/feedback.json",
        renderer: "svg",
        loop: !1,
        autoplay: !1,
        name: "Feed Back"
    ...
    feedBackEnd = bodymovin.loadAnimation({
        ...
        path: "../../../lib-native/crossword_6r/content/json/feedbackend.json",
        renderer: "svg",
        loop: !1,
        autoplay: !1,
        name: "Feed Back End"
