  ...
  methods: {
    ...
    moverStart() {
      ...
      setTimeout(() => {
        ...
        document.querySelector(".question.active").classList.remove("disPointer")
      }, 3000);
    },
    clickInput() {
      this.helpHand = false
    ...
    calculate() {
      this.Estimation = calculate(this.result,this.loQuestion,this.isEng,this.upper)[0]
      this.finalProgress = calculate(this.result,this.loQuestion,this.isEng,this.upper)[1]
    },
    finished() {
