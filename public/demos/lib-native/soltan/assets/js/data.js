  ...
  let instractions = [
    {
      ...
      img: "../../../lib-native/soltan/assets/images/icons/muisc.png",
    },
    {
      parag: "اضغط على هذا الرمز للعودة إلى الشاشة الرئيسة.",
      img: "../../../lib-native/soltan/assets/images/icons/home.png",
    },
    {
      parag: "اضغط على زر <span>تم</span> للذهاب إلى أسئلة القطعة. ",
      img: "../../../lib-native/soltan/assets/images/icons/done.png",
      class: "done",
    },
    {
      parag:
        "اضغط على هذا الرمز للعودة إلى شاشة القطعة والذهاب للأسئلة مرة أخرى.",
      img: "../../../lib-native/soltan/assets/images/icons/min.png",
      class: "twoImg",
    },
    {
      parag: "اضغط على هذا الرمز لسماع أو إيقاف صوت القطعة.",
      img: "../../../lib-native/soltan/assets/images/icons/play.png",
      class: "twoImg",
    },
    {
      parag: "اضغط على هذا الرمز لإعادة سماع صوت القطعة من البداية.",
      img: "../../../lib-native/soltan/assets/images/icons/sound.png",
    },
    {
      parag: "اضغط على هذا الرمز للتأكد من صحة الإجابة.",
      img: "../../../lib-native/soltan/assets/images/icons/check.png",
    },

    {
      parag: "اضغط على هذا الرمز لمسح تحديد الكلمة.",
      img: "../../../lib-native/soltan/assets/images/icons/reload.png",
    },
    {
      parag: "اضغط على زر <span>إظهار الإجابة</span> عند الإجابة بشكل خطأ.",
      img: "../../../lib-native/soltan/assets/images/icons/showanswer.png",
      class: "showanswer",
    },
    {
      parag:
        "اضغط على هذا الرمز حتى تحصل على مساعدة واحدة في كل سؤال عدا سؤال «حدِّد الكلمات الخطأ» فلك فيها وسيلتان للمساعدة.",
      img: "../../../lib-native/soltan/assets/images/icons/msbaha.png",
      class: "masbah",
    },
    {
      parag: "يشير هذا الرمز إلى المدة الزمنية المخصصة لحل كل سؤال.",
      img: "../../../lib-native/soltan/assets/images/icons/timer.png",
      class: "timer",
    },
    {
      parag: "يشير هذا الرمز إلى مدى التقدم في حل الأسئلة.",
      img: "../../../lib-native/soltan/assets/images/icons/progress.png",
      class: "progress",
    },
    {
      parag:
        "اضغط على هذه الرموز للتنقل بين الشاشات لمراجعة إجاباتك عن الأسئلة.",
      img: "../../../lib-native/soltan/assets/images/icons/next.png",
      class: "twoImg",
    },
    {
      parag: "اضغط على هذا الرمز للعودة إلى الشاشة الرئيسة.",
      img: "../../../lib-native/soltan/assets/images/icons/exit.png",
    },
  ];
 return {
    correctWords,
