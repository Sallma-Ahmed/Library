...
let vue = new Vue({
  ...
  async mounted() {
    await this.getData();
    this.bgAudio.src = "../../../lib-native/crossword_4r/audio/music.mp3";

    this.clickBtn.src = "../../../lib-native/crossword_4r/audio/click_btn.mp3";
  ...
  methods: {
    ...
    getData: async function () {
      ...
      var jsonRes = [
        pageUrl + ".json",
        "../../../lib-native/crossword_4r/content/json/keys.json",
      ];
      !this.dataloaded
    ...
    startClickGame: function () {
      ...
      setTimeout(() => {
        ...
        this.hint.src = "../../../lib-native/crossword_4r/audio/hint.mp3";
        this.hint.play();
        document.getElementById("boxNumber1").classList.add("help");
      }, 1000);
       
      this.sound.src = "../../../lib-native/crossword_4r/audio/click_btn.mp3";
      this.sound.play();
    },
